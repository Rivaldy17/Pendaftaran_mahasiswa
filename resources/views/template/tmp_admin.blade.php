                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="campusai_admin_dashboard">Dashboard</a></li>
                        </ul>
                    </li>

                    <li class="nav-label">List</li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-check-square-11"></i><span class="nav-text"><?=setting()->nama_cam ?></span></a>
                        <ul aria-expanded="false">
                            <li><a href="list_user">List User</a></li>
                            <li><a href="list_lokasi">List Lokasi Kampus</a></li>
                            <li><a href="list_studi">List Program Studi</a></li>
                           
                        </ul>
                    </li>
                    <li class="nav-label">Pendaftaran</li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-users-mm"></i><span class="nav-text"><?=setting()->nama_cam ?></span></a>
                        <ul aria-expanded="false">
                        <li><a href="list_calon">List Calon Mahasiswa</a></li>
                        </ul>
                    </li>
